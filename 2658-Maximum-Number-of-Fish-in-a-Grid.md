`Methods:`BFS </br> `Data Structure:`undefined </br> `Difficulty:`Medium </br> `Similar:`undefined </br> -------------------------------- </br>You are given a **0-indexed** 2D matrix `grid` of size `m x n`, where `(r, c)` represents:
