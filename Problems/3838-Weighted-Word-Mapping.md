# 3838. Weighted Word Mapping  
  ...
  Methods: Basic logic </br> Difficulty: Easy </br> </br>You are given an array of strings `words`, where each string represents a word containing lowercase English letters.
