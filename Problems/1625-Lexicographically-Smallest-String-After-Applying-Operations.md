# 1625. Lexicographically Smallest String After Applying Operations  
  ...
  Methods: BFS </br> Data Structure: Set,Queue </br> Difficulty: Medium </br> </br>You are given a string `s` of **even length** consisting of digits from `0` to `9`, and two integers `a` and `b`.
